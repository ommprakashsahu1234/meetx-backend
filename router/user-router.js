...
const { sendOtp, verifyOtpAndRegister, getProfile, followUser, unfollowUser, reportUser, getFollowersWithMutuals, getFollowingWithMutuals,
     getFollowersList, getFollowingList, getSuggestedUsers } = require("../controllers/auth-controller");
